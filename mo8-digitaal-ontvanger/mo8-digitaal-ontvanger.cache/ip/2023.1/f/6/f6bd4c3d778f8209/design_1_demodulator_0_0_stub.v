...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset, signal_i, counter_o, 
  couter_running_o, counter_finished_o, bits_read_o, data_o)
/* synthesis syn_black_box black_box_pad_pin="reset,signal_i,counter_o[15:0],couter_running_o,counter_finished_o,bits_read_o[2:0],data_o[7:0]" */
