...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_demodulator is
  ...
  signal data_o_ready_i_2_n_0 : STD_LOGIC;
...
data_o_ready_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAAAAAAAAAAAAA8"
    )
        port map (
      I0 => \data_o[7]_i_1_n_0\,
      I1 => data_o_ready_i_2_n_0,
      I2 => signal_buffer(7),
      I3 => signal_buffer(4),
      I4 => signal_buffer(3),
      I5 => signal_buffer(1),
...
data_o_ready_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
