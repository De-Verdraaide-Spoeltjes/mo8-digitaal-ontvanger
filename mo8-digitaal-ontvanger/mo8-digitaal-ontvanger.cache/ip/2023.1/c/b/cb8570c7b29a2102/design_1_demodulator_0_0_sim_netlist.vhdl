...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_demodulator is
  ...
  signal \bits_read[2]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \bits_read[2]_i_5\ : label is "soft_lutpair0";
...
\bits_read[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \bits_read[2]_i_3_n_0\,
      I3 => \bits_read[2]_i_4_n_0\,
      I4 => \bits_read[2]_i_5_n_0\,
      I5 => \bits_read[2]_i_6_n_0\,
...
\bits_read[2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\bits_read[2]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
