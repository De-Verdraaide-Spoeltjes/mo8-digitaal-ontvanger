...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_demodulator is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_4\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \bits_read[0]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of data_o_save_reg_i_1 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \next_state_o[0]_INST_0_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \next_state_o[1]_INST_0_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \next_state_o[1]_INST_0_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \next_state_o[1]_INST_0_i_5\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \next_state_o[1]_INST_0_i_6\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \next_state_o[2]_INST_0_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \next_state_o[2]_INST_0_i_2\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of output_ready_o_reg_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \state_o[0]_INST_0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \state_o[1]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \state_o[2]_INST_0\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of timer_enable_o_reg_i_2 : label is "soft_lutpair5";
...
\bits_read_reg[30]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(1 downto 0) => in11(30 downto 29),
      S(3 downto 2) => B"00",
...
\next_state_o[0]_INST_0_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
      I0 => \signal_buffer_reg_n_0_[1]\,
...
\next_state_o[1]_INST_0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\next_state_o[1]_INST_0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2F"
    )
        port map (
...
\next_state_o[1]_INST_0_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \bits_read_reg_n_0_[27]\,
      I5 => \bits_read_reg_n_0_[28]\,
      O => \next_state_o[1]_INST_0_i_3_n_0\
    );
\next_state_o[1]_INST_0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
      I0 => \bits_read_reg_n_0_[0]\,
      I1 => \bits_read_reg_n_0_[1]\,
      I2 => \bits_read_reg_n_0_[2]\,
...
\next_state_o[1]_INST_0_i_7\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      ...
      I2 => \bits_read_reg_n_0_[18]\,
      I3 => \bits_read_reg_n_0_[25]\,
      I4 => \bits_read_reg_n_0_[29]\,
      I5 => \bits_read_reg_n_0_[16]\,
      O => \next_state_o[1]_INST_0_i_7_n_0\
    );
...
\next_state_o[2]_INST_0_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFD"
    )
        port map (
      I0 => \bits_read_reg_n_0_[0]\,
      I1 => \bits_read_reg_n_0_[30]\,
      I2 => \bits_read_reg_n_0_[27]\,
      I3 => \bits_read_reg_n_0_[28]\,
      I4 => \next_state_o[2]_INST_0_i_4_n_0\,
      O => \next_state_o[2]_INST_0_i_1_n_0\
    );
\next_state_o[2]_INST_0_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00004000"
    )
        port map (
      I0 => \next_state_o[2]_INST_0_i_5_n_0\,
      I1 => \bits_read_reg_n_0_[2]\,
      I2 => \bits_read_reg_n_0_[1]\,
      I3 => state(1),
      I4 => state(2),
      O => \next_state_o[2]_INST_0_i_2_n_0\
    );
\next_state_o[2]_INST_0_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
      I0 => \bits_read_reg_n_0_[15]\,
...
\next_state_o[2]_INST_0_i_4\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => \bits_read_reg_n_0_[25]\,
      I2 => \bits_read_reg_n_0_[18]\,
      I3 => \next_state_o[2]_INST_0_i_7_n_0\,
      I4 => \next_state_o[2]_INST_0_i_8_n_0\,
      O => \next_state_o[2]_INST_0_i_4_n_0\
    );
\next_state_o[2]_INST_0_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      I0 => \bits_read_reg_n_0_[8]\,
      I1 => \bits_read_reg_n_0_[7]\,
      I2 => \bits_read_reg_n_0_[6]\,
      I3 => \bits_read_reg_n_0_[5]\,
      I4 => \bits_read_reg_n_0_[3]\,
      I5 => \bits_read_reg_n_0_[4]\,
      O => \next_state_o[2]_INST_0_i_5_n_0\
    );
\next_state_o[2]_INST_0_i_6\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFFFFFFFFE"
    )
        port map (
      I0 => \bits_read_reg_n_0_[14]\,
      I1 => \bits_read_reg_n_0_[13]\,
      I2 => \bits_read_reg_n_0_[12]\,
      I3 => \bits_read_reg_n_0_[11]\,
      I4 => \bits_read_reg_n_0_[9]\,
      I5 => \bits_read_reg_n_0_[10]\,
      O => \next_state_o[2]_INST_0_i_6_n_0\
    );
\next_state_o[2]_INST_0_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \bits_read_reg_n_0_[24]\,
      I1 => \bits_read_reg_n_0_[21]\,
      I2 => \bits_read_reg_n_0_[26]\,
...
\next_state_o[2]_INST_0_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
        ...
        port map (
      I0 => \bits_read_reg_n_0_[20]\,
      I1 => \bits_read_reg_n_0_[17]\,
      I2 => \bits_read_reg_n_0_[22]\,
...
\signal_buffer[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => signal_i,
      I1 => \bits_read_reg_n_0_[2]\,
      I2 => \bits_read_reg_n_0_[0]\,
      I3 => \bits_read_reg_n_0_[1]\,
...
\signal_buffer[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \next_state_o[1]_INST_0_i_1_n_0\,
      I2 => \next_state_o[1]_INST_0_i_7_n_0\,
      I3 => \signal_buffer[7]_i_3_n_0\,
      I4 => \next_state_o[2]_INST_0_i_5_n_0\,
      I5 => \next_state_o[2]_INST_0_i_6_n_0\,
      O => \signal_buffer[7]_i_2_n_0\
    );
\signal_buffer[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
