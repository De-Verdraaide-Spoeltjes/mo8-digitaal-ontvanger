...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_demodulator is
  ...
  signal \bits_read_reg[2]_i_2_n_0\ : STD_LOGIC;
  signal \bits_read_reg[2]_i_2_n_1\ : STD_LOGIC;
  signal \bits_read_reg[2]_i_2_n_2\ : STD_LOGIC;
  signal \bits_read_reg[2]_i_2_n_3\ : STD_LOGIC;
  signal \bits_read_reg[2]_i_2_n_4\ : STD_LOGIC;
  signal \bits_read_reg[2]_i_2_n_5\ : STD_LOGIC;
  signal \bits_read_reg[2]_i_2_n_6\ : STD_LOGIC;
  signal \bits_read_reg[2]_i_2_n_7\ : STD_LOGIC;
  ...
  signal \^signal_i_edge_o\ : STD_LOGIC;
  ...
  attribute ADDER_THRESHOLD of \bits_read_reg[2]_i_2\ : label is 11;
  ...
  attribute SOFT_HLUTNM of \next_state_o[1]_INST_0_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \next_state_o[1]_INST_0_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \next_state_o[2]_INST_0_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \next_state_o[2]_INST_0_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \state_o[0]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \state_o[1]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of timer_reset_o_i_1 : label is "soft_lutpair4";
begin
...
\bits_read[2]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\bits_read_reg[2]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \bits_read_reg[2]_i_2_n_0\,
      CO(2) => \bits_read_reg[2]_i_2_n_1\,
      CO(1) => \bits_read_reg[2]_i_2_n_2\,
      CO(0) => \bits_read_reg[2]_i_2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0001",
      O(3) => \bits_read_reg[2]_i_2_n_4\,
      O(2) => \bits_read_reg[2]_i_2_n_5\,
      O(1) => \bits_read_reg[2]_i_2_n_6\,
      O(0) => \bits_read_reg[2]_i_2_n_7\,
      S(3) => bits_read_reg(3),
      S(2 downto 1) => \^bits_read_o\(2 downto 1),
      S(0) => \bits_read[2]_i_3_n_0\
    );
...
\next_state_o[1]_INST_0_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000002E"
    )
        port map (
...
\next_state_o[2]_INST_0_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\next_state_o[2]_INST_0_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\next_state_o[2]_INST_0_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
