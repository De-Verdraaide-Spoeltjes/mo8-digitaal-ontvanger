...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_demodulator is
  ...
  signal counter_finished0_carry_i_8_n_0 : STD_LOGIC;
...
counter_finished0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(2) => counter_finished0_carry_i_2_n_0,
      DI(1) => counter_finished0_carry_i_3_n_0,
      DI(0) => counter_finished0_carry_i_4_n_0,
      O(3 downto 0) => NLW_counter_finished0_carry_O_UNCONNECTED(3 downto 0),
      S(3) => counter_finished0_carry_i_5_n_0,
      S(2) => counter_finished0_carry_i_6_n_0,
      S(1) => counter_finished0_carry_i_7_n_0,
      S(0) => counter_finished0_carry_i_8_n_0
    );
...
counter_finished0_carry_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
