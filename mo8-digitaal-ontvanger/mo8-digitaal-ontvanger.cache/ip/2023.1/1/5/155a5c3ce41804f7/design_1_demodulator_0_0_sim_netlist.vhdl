...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_demodulator is
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "save_output:100,write_output:011,poll_data:010,reset_timer:001,await_bit:101,idle:000";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "save_output:100,write_output:011,poll_data:010,reset_timer:001,await_bit:101,idle:000";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]\ : label is "save_output:100,write_output:011,poll_data:010,reset_timer:001,await_bit:101,idle:000";
  ...
  attribute SOFT_HLUTNM of data_o_ready_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of timer_enable_o_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of timer_reset_o_i_1 : label is "soft_lutpair0";
begin
\FSM_sequential_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CFCCCFCCCCFFCCEE"
    )
        port map (
      I0 => state(1),
