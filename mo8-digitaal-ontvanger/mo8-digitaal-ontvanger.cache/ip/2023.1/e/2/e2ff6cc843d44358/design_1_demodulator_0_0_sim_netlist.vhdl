...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_demodulator is
  ...
  signal counter_running_i_1_n_0 : STD_LOGIC;
  signal \^couter_running_o\ : STD_LOGIC;
  signal data0 : STD_LOGIC_VECTOR ( 31 downto 1 );
  signal signal_buffer0 : STD_LOGIC;
  signal \^signal_buffer_o\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal signal_i_r : STD_LOGIC;
  ...
  attribute ADDER_THRESHOLD of \counter_reg[15]_i_2\ : label is 11;
...
counter2_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => counter2_carry_i_1_n_0,
      DI(0) => counter2_carry_i_2_n_0,
      O(3 downto 0) => NLW_counter2_carry_O_UNCONNECTED(3 downto 0),
      S(3) => counter2_carry_i_3_n_0,
      S(2) => counter2_carry_i_4_n_0,
      S(1) => counter2_carry_i_5_n_0,
      S(0) => counter2_carry_i_6_n_0
    );
\counter2_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => \counter2_carry__0_i_1_n_0\,
      DI(1) => \counter2_carry__0_i_2_n_0\,
      DI(0) => \counter2_carry__0_i_3_n_0\,
      O(3 downto 0) => \NLW_counter2_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \counter2_carry__0_i_4_n_0\,
      S(2) => \counter2_carry__0_i_5_n_0\,
      S(1) => \counter2_carry__0_i_6_n_0\,
      S(0) => \counter2_carry__0_i_7_n_0\
    );
...
\counter2_carry__0_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter2_carry__0_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\counter2_carry__0_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
counter2_carry_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
counter_running_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
counter_running_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
signal_i_r_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
