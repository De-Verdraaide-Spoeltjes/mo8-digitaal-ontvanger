...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_demodulator is
  ...
  signal data_o_save_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_5\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of data_o_save_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \signal_buffer[7]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of timer_enable_o_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of timer_reset_o_i_1 : label is "soft_lutpair2";
begin
...
data_o_save_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
data_o_save_reg: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
...
\signal_buffer[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEFF0200"
    )
        port map (
...
\signal_buffer[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEFF0200"
    )
        port map (
...
\signal_buffer[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF2000"
    )
        port map (
...
\signal_buffer[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF2000"
    )
        port map (
...
\signal_buffer[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF2000"
    )
        port map (
...
\signal_buffer[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF2000"
    )
        port map (
...
\signal_buffer[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
...
\signal_buffer[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\signal_buffer[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
