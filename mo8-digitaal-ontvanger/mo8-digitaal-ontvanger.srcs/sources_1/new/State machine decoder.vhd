...
ARCHITECTURE Behavioral OF decoder_state_machine IS
...
--add_force {/decoder_state_machine/clk} -radix hex {0 0ns} {1 5000ps} -repeat_every 10000ps
--run 100 ns
--add_force {/decoder_state_machine/Data_rdy} -radix hex {0 0ns}
--run 100 ns
--add_force {/decoder_state_machine/Data_in} -radix bin {111100100110100101010101001011011100111110010100111011010111110101101111100111011111001001101001010101010010110111001111100101001110110101111101011011111001110111110010011010010101010100101101110011111001010011101101011111010110111110011101 0ns}
--run 100 ns
--add_force {/decoder_state_machine/Data_rdy} -radix hex {1 0ns}
--run 100 ns
--add_force {/decoder_state_machine/Data_rdy} -radix hex {0 0ns}
--run 2000 ns
--add_force {/decoder_state_machine/Data_in} -radix bin {111100100110100101010101001011011100111110010100111011010111110101101111100111011111001001101001010101010010110111001111100101001110110101111101011011111001110111110010011010010101010100101101110011111001010011101101011111010110111110011101 0ns}
