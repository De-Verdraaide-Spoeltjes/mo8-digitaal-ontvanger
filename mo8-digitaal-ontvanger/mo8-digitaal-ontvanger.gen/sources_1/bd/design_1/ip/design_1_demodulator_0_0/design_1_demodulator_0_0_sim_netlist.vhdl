...
-- Date        : Fri Apr 12 11:44:38 2024
-- Host        : Lenovo-Jochem running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top design_1_demodulator_0_0 -prefix
--               design_1_demodulator_0_0_ design_1_demodulator_0_0_sim_netlist.vhdl
...
counter2_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(1) => '0',
      DI(0) => counter2_carry_i_3_n_0,
      O(3 downto 0) => NLW_counter2_carry_O_UNCONNECTED(3 downto 0),
      S(3) => counter2_carry_i_4_n_0,
      S(2) => counter2_carry_i_5_n_0,
      S(1) => counter2_carry_i_6_n_0,
      S(0) => counter2_carry_i_7_n_0
    );
...
counter2_carry_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
