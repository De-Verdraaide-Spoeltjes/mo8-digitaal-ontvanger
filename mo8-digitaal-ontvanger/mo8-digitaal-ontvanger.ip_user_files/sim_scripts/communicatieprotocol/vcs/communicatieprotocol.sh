...
design_libs=(xilinx_vip xpm fifo_generator_v13_2_8 xil_defaultlib xlslice_v1_0_2)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_8 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xlslice_v1_0_2 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.communicatieprotocol xil_defaultlib.glbl -o communicatieprotocol_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./communicatieprotocol_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key communicatieprotocol_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc communicatieprotocol_simv.daidir vcs_lib c.obj)
