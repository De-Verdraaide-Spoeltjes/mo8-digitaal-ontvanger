...
#
# Script generated by Vivado on Thu Apr 11 11:14:05 +0200 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : communicatieprotocol.sh
...
#
# Usage        : communicatieprotocol.sh
#                communicatieprotocol.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                communicatieprotocol.sh [-reset_run]
#                communicatieprotocol.sh [-reset_log]
#                communicatieprotocol.sh [-help]
#
...
#                script (type 'communicatieprotocol.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname fifo_generator_v13_2_8 -libname xil_defaultlib -libname xlslice_v1_0_2 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm fifo_generator_v13_2_8 xil_defaultlib xlslice_v1_0_2)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "communicatieprotocol.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./communicatieprotocol.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work fifo_generator_v13_2_8 $xmvlog_opts +incdir+"$ref_dir/../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xlslice_v1_0_2 $xmvlog_opts +incdir+"$ref_dir/../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"../../../../mo8-digitaal-ontvanger.gen/sources_1/bd/communicatieprotocol/ipshared/30ef" +incdir+"C:/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.communicatieprotocol xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.communicatieprotocol -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log communicatieprotocol_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./communicatieprotocol.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: communicatieprotocol.sh [-help]\n\
Usage: communicatieprotocol.sh [-step]\n\
Usage: communicatieprotocol.sh [-lib_map_path]\n\
Usage: communicatieprotocol.sh [-reset_run]\n\
Usage: communicatieprotocol.sh [-reset_log]\n\
Usage: communicatieprotocol.sh [-keep_index]\n\
Usage: communicatieprotocol.sh [-noclean_files]\n\n\
