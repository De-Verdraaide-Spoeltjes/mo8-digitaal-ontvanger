...
# set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_14 -L processing_system7_vip_v1_0_16 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L xlslice_v1_0_2 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot communicatieprotocol xil_defaultlib.communicatieprotocol xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim communicatieprotocol -key {Behavioral:sim_1:Functional:communicatieprotocol} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/communicatieprotocol.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb communicatieprotocol.wdb xsim.dir libdpi.so)
